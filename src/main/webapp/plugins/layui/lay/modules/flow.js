...
layui.define('jquery', function(exports){
  ...
  Flow.prototype.load = function(options){
    ...
    var end = options.end || '<li><div class="layui-flow-more"><a href="javascript:;">没有更多了</a></div></li>'; //“末页”显示文案
    ...
    ,more = $('<ul class="notes"><li><div class="layui-flow-more"><a href="javascript:;">'+ ELEM_TEXT +'</a></div></li></ul>');
